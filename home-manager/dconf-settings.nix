...

{
  dconf.settings = {
    ...
    "org/gnome/shell" = {
      ...
      favorite-apps = [ "chromium-browser.desktop" "firefox.desktop" "code.desktop" "terminator.desktop" "org.gnome.Nautilus.desktop" "signal-desktop.desktop" "org.keepassxc.KeePassXC.desktop" "@joplinapp-desktop.desktop" "thunderbird.desktop" ];
